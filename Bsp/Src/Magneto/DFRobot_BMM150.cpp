...
void DFRobot_BMM150::getOperationMode(char *buffer)
{
  uint8_t regData = 0;
  uint8_t powerData = 0;
  uint8_t number = 0;
  ...
  {
    case BMM150_POWERMODE_NORMAL:
    	strcpy(buffer, "bmm150 is normal mode!");
      break;
    case BMM150_POWERMODE_FORCED:
    	strcpy(buffer, "bmm150 is forced mode!");
      break;
    case BMM150_POWERMODE_SLEEP:
    	strcpy(buffer, "bmm150 is sleep mode!");
      break;
    case BMM150_POWERMODE_SUSPEND:
    	strcpy(buffer, "bmm150 is suspend mode!");
      break;
    default:
    	strcpy(buffer, "error mode!");
      break;
  }
}
...
sBmm150MagData_t DFRobot_BMM150::getGeomagneticData(void)
{
  ...
  magData.x = rawMagData.rawDataX;//compensateX(rawMagData.rawDataX, rawMagData.rawDataR);
  magData.y = rawMagData.rawDataY;//compensateY(rawMagData.rawDataY, rawMagData.rawDataR);
  magData.z = rawMagData.rawDataZ;//compensateZ(rawMagData.rawDataZ, rawMagData.rawDataR);
...
void DFRobot_BMM150::getMeasurementStateXYZ(char *buffer)
{
  uint8_t regData = 0;
  getReg(BMM150_REG_AXES_ENABLE, &regData, 1);
  regData = (regData&0x38)>>3;
  ...
  {
    case 0:
      strcpy(buffer, "The xyz axis is enable!");
      break;
    case 1:
    	strcpy(buffer, "The yz axis is enable!");
      break;
    case 2:
    	strcpy(buffer, "The xz axis is enable!");
      break;
    case 3:
    	strcpy(buffer, "The z axis is enable!");
      break;
    case 4:
    	strcpy(buffer, "The xy axis is enable!");
      break;
    case 5:
    	strcpy(buffer, "The y axis is enable!");
      break;
    case 6:
    	strcpy(buffer, "The x axis is enable!");
      break;
    case 7:
    	strcpy(buffer, "The xyz axis is not enabled !");
      break;
  }
}
...
DFRobot_BMM150_I2C::DFRobot_BMM150_I2C(I2C_HandleTypeDef *pWire, uint8_t addr)
{
  _pWire = pWire;
  this->_I2C_addr = addr;
}
...
{
	HAL_I2C_Mem_Write(_pWire, this->_I2C_addr, Reg, 1, Data, len, 10);
}

int16_t DFRobot_BMM150_I2C::readData(uint8_t Reg, uint8_t *Data ,uint8_t len)
{

  HAL_I2C_Mem_Read(_pWire, this->_I2C_addr, Reg, 1, Data, len, 10);
  return 0;
}
